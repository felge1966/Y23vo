;vp01.08.2019 restauriert aus neuerer Quelle (y23vo.zip)
...
M0009:	BIT	7,(HL)
	...
	JR	Z,M0009
	LD	A,D
	XOR	(HL)		;GLEICHE BITS WEG
	INC	HL
	AND	(HL)		;VERAENDERLICHE BITS WEG
	INC	HL
...
M000E:	LD	HL,T2
	...
	CALL	M000A		;REG. VORB.
M000F:	INC	A
M0010:	BIT	7,(HL)		;SUCHE Z.MIT STOP,MAX (A) PLAETZE
	INC	HL
	JR	Z,M0010
	DEC	A
	JR	NZ,M0010
