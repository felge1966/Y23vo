	...
	; 2020-04-08 version fuer 2kB BWS Anderungen ;####
...
ROM:	EQU	0F000H
RAM:	EQU	0D000H		;####ROM+0800H	;****
RESTR: 	EQU 	ROM+0400H	; 
BRAM: 	EQU	0F800H		;####0FC00H 		;BILDSCHIRM-RAM
BRSIZE	EQU	2048		;#### 
...
BLOE:	PUSH	HL
	PUSH	DE
	PUSH	BC
	LD	HL, BRAM+BRSIZE-1	;####1023	;BILDSCHIRM LOESCHEN
	LD	DE, BRAM+BRSIZE-2	;####1022
	LD	BC, BRSIZE-1		;####1023	;ANZAHL
	LD	(HL), ' '	;LEERZEICHEN
	LDDR
	LD	(CURS), HL
	POP	BC
