...
VOLL:	LD	A, H
	CP	HIGH(BRAM+BRSIZE);####HIGH(BRAM+1024)
...
BLOE:	PUSH	HL
	PUSH	DE
	PUSH	BC
	LD	HL, BRAM+BRSIZE-1	;####HL, BRAM+1023	;BILDSCHIRM LOESCHEN
	LD	DE, BRAM+BRSIZE-2	;####DE, BRAM+1022
	LD	BC, BRSIZE-1		;####BC, 1023		;ANZAHL
	LD	(HL), ' '	;LEERZEICHEN
	LDDR
	LD	(CURS), HL
	POP	BC
