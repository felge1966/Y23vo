...
VERIFY1:LD	A,(DE)
	CP	(HL)
	JP	NZ,HALTE	;jump to halt routine.
	INC	DE
	INC	HL
	DEC	B
	JP	NZ,VERIFY1
...
;
HALTE:	LD	HL,76F3H	;'DI HLT' instructions.
	LD	(CBASE),HL
	LD	HL,CBASE
	JP	(HL)
;
...
;WBOOT:	JP	0		; Kann durch equ ersetzt werden, weil die Tabelle steht schon im Kramer CBIOS
;CONST:	JP	0
;CONIN:	JP	0
;CONOUT:	JP	0
;LIST:	JP	0
...
CONST:		EQU	BOOT+006H
CONIN:		EQU	BOOT+009H
CONOUT:		EQU	BOOT+00CH
LIST:		EQU	BOOT+00FH
PUNCH:		EQU	BOOT+012H
READER:		EQU	BOOT+015H
HOME:		EQU	BOOT+018H
SELDSK:		EQU	BOOT+01BH
SETTRK:		EQU	BOOT+01EH
SETSEC:		EQU	BOOT+021H
SETDMA:		EQU	BOOT+024H
READ:		EQU	BOOT+027H
WRITE:		EQU	BOOT+02AH
PRSTAT:		EQU	BOOT+02DH
SECTRN:		EQU	BOOT+030H
;
;
;*
;******************   E N D   O F   C P / M   *****************
