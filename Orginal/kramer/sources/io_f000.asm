...
;Version 0F000h S. 199
;reass V.Pohlers 08/2019



	TITLE "I-O MONITOR Y23VO"
...
EOM: 	EQU 	ROM+0B00H 	;SYSTEMRAM
STACK:	EQU 	ROM+0BCEH
RSLOC:	EQU 	ROM+0BE3H	;USER-STACK
CURS:	EQU 	ROM+0BF1H	;AKT.BILDSCHIRMPLATZ
FLGIO:	EQU 	ROM+0BFEH 	;SPEICHERPLATZ F.STEUERUNG I/O-GERAETE
IOBYT:	EQU 	ROM+0BFFH 	;SPEICHERPLATZ F.STEUERUNG I/O-GERAETE
RAMZK:	EQU 	ROM+0BFCH
...
LT:	EQU	0		;LIST-GERAET   L = TERMINAL (BILDSCHIRM)
...
ULOCR: 	EQU 	ROM+0BF9H
ASS: 	EQU	0C800H		;ASSEMBLER
BASIC:	EQU 	8000H
PRINT:	EQU 	0E800H 		;REASSEMBLER
